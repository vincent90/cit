...
@section("content")
    <div class="container">
        ...
        <div class="row mainContent">
            ...
            <div class="col-md-4">
                <div class="row">
                    <div class="col-md-12 rotate" style="background:#e67e22;height:300px;padding:10px;"><a href="{{ URL::route("user/profile") }}"><img src="{{asset('assets/images/back.png')}}" style="width:100%"></a></div>
                </div>
            </div>
        </div>
    </div> <!-- /container -->
